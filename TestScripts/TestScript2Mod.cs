...
public class TestScript2Mod : IHoldfastSharedMethods2
{
    ...
    {
        Debug.LogFormat("OnOfficerOrderStart {0} {1}", officerPlayerId, highCommandOrderType);
    }

    public void OnOfficerOrderStop(int officerPlayerId, HighCommandOrderType highCommandOrderType)
    {
        Debug.LogFormat("OnOfficerOrderStop {0} {1}", officerPlayerId, highCommandOrderType);
    }
